...
```
aws ssm put-parameter --name "/my/dockerhub/username" --type String --value ${DOCKERHUB_USERNAME}
aws ssm put-parameter --name "/my/dockerhub/password" --type String --value ${DOCKERHUB_PASSWORD}
